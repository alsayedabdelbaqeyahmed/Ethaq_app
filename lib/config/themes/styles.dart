...
class AppStyles {
  ...
  static const TextStyle subtitle500 = TextStyle(
    color: AppColors.cTextSubtitleLight,
    fontWeight: FontWeight.w500,
    fontSize: AppFontSize.f12,
  );
  static const TextStyle subtitle600 = TextStyle(
    color: AppColors.cTextSubtitleLight,
    fontWeight: FontWeight.w600,
    fontSize: AppFontSize.f12,
  );
  static const TextStyle subtitle700 = TextStyle(
    color: AppColors.cTextSubtitleLight,
    fontWeight: FontWeight.w700,
    fontSize: AppFontSize.f12,
  );
  static const TextStyle subtitle800 = TextStyle(
    color: AppColors.cTextSubtitleLight,
    fontWeight: FontWeight.w800,
    fontSize: AppFontSize.f12,
  );
  static const TextStyle subtitle900 = TextStyle(
    color: AppColors.cTextSubtitleLight,
    fontWeight: FontWeight.w900,
    fontSize: AppFontSize.f12,
  );
